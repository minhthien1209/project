                        ...
                        ?>
                          <tr>
                            <form method="post">
                              ...
                              <td>
                                <select class="form-select" aria-label="Default select example" name="donvi">
      ...
      <div class="col-sm-4" id="getId" data-value="<?php echo $i; ?>">
        <form method="post" class="form-add">
          ...
          <div class="donhang">
            ...
            <p id="tongtien1">Tiền Hàng <?php $tam = 0;
                                        if (isset($_SESSION['cart'])) {
                                          foreach ($_SESSION['cart'] as $key => $val) {
                                            $tam += $val['sl'] * $val['gia'];
                                          }
            ...
            <input onchange="nhap();" type="number" min="0" class="dl" name="">
