...
$sql_ins_xuatkhoa = mysqli_query($conn, "INSERT INTO xuatkhoa(ngayxuatvien,benhnhan,benhan,nguoinha,diachi,sothebhyt,chinhsach,benhchuandoan,bacsidieutri,chiphiravien) VALUES ('$today','$hoten_bn','$id_ba','$hoten_nh','$diachi','$sothebhyt','$chinhsach','$benhchuandoan','$bacsi','$tongchiphi')");
if ($sql_ins_xuatkhoa) {
